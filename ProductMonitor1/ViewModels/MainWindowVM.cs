...
namespace ProductMonitor1.ViewModels
{
    internal class MainWindowVM : INotifyPropertyChanged
    {
        ...
        public MainWindowVM()
        {
            ...
            AlarmList.Add(new AlarmModel { Num = "01", Msg = "设备温度过高", Time = "2024-04-23 18:34:56", Duration = 7 });
            AlarmList.Add(new AlarmModel { Num = "02", Msg = "车间温度过高", Time = "2024-05-08 20:40:59", Duration = 10 });
            AlarmList.Add(new AlarmModel { Num = "03", Msg = "设备转速过快", Time = "2024-06-05 12:24:34", Duration = 12 });
            AlarmList.Add(new AlarmModel { Num = "04", Msg = "设备气压偏低", Time = "2024-07-04 19:58:00", Duration = 90 });
            #endregion
            ...
            StuffOutWorkList.Add(new StuffOutWorkModel { StuffName = "王克俭", Position = "技术员", OutWorkCount = 84 });
            StuffOutWorkList.Add(new StuffOutWorkModel { StuffName = "陈家栋", Position = "统计员", OutWorkCount = 143 });
            StuffOutWorkList.Add(new StuffOutWorkModel { StuffName = "刘天", Position = "技术员", OutWorkCount = 42 });
            ...
            WorkShopList.Add(new WorkShopModel { WorkShopName = "点胶车间", WorkingCount = 68, WaitCount = 8, WrongCount = 4, StopCount = 0 });
        ...
        public string WeekStr
        {
            get
            {
                ...
                string[] weekstr = new string[7] { "星期一", "星期二", "星期三", "星期四", "星期五", "星期六", "星期天" };
        ...
        /// 机台总数
        /// </summary>
        private string _MachineCount = "02381";
        ...
        /// 生产计数
        /// </summary>
        private string _ProductCount = "13543";
